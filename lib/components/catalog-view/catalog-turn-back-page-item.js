...
var CatalogTurnBackPageItem = exports["default"] = /*#__PURE__*/function (_Component) {
  function CatalogTurnBackPageItem(props) {
    var _this;
    _classCallCheck(this, CatalogTurnBackPageItem);
    _this = _callSuper(this, CatalogTurnBackPageItem, [props]);
    _this.state = {
      hover: false
    };
    return _this;
  ...
  return _createClass(CatalogTurnBackPageItem, [{
    key: "changePage",
