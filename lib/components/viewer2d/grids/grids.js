  ...
  var renderedGrids = grids.entrySeq().map(function (_ref2) {
    ...
    switch (grid.type) {
      case 'horizontal-streak':
        return _react2.default.createElement(_gridHorizontalStreak2.default, { key: gridID, width: width, height: height, grid: grid, theme: theme });

      case 'vertical-streak':
        return _react2.default.createElement(_gridVerticalStreak2.default, { key: gridID, width: width, height: height, grid: grid, theme: theme });
