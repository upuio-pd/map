...
function State(_ref) {
  ...
  return _react2.default.createElement(
    'g',
    null,
    _react2.default.createElement('rect', { x: '0', y: '0', width: width, height: height, fill: localStorage.theme == 'dark' ? "#292929" : "#FFF" }),
    _react2.default.createElement(
      'g',
      { transform: 'translate(0, ' + scene.height + ') scale(1, -1)', id: 'svg-drawing-paper' },
      _react2.default.createElement(_scene2.default, { scene: scene, catalog: catalog, theme: theme }),
